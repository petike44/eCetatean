...
export function findProcedure(eventType) {
    return LIFE_EVENTS[eventType] ?? null;
}
export function detectEventType(message) {
    const msg = message.toLowerCase();
    // Car from Germany / EU (higher priority than generic bought_car)
    if ((msg.includes('mașin') || msg.includes('masin') || msg.includes('auto')) &&
