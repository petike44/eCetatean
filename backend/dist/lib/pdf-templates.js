            ...
            inputs = [
                {
                    ...
                    'Solicit înscrierea reședinței la adresa': additionalData.new_address ?? '_______________',
            ...
            inputs = [
                {
                    ...
                    'Vehicul — Marcă și Model': `${additionalData.make ?? ''} ${additionalData.model ?? ''}`.trim() ||
                        '_______________',
