...
if (!isSupabaseConfigured) {
    console.warn('⚠️  Supabase nu este configurat (SUPABASE_URL / SUPABASE_SERVICE_ROLE_KEY lipsesc).\n' +
...
export const supabaseAdmin = createClient(url || 'http://localhost:54321', key || 'placeholder-service-role-key', {
    auth: {
