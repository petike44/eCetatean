...
export const LIFE_EVENTS: Record<string, LifeEventProcedure> = {
  ...
  car_domestic: {
    ...
    steps: [
      ...
      },
      {
        ...
        deadline: 'Înainte de pasul 2',
        form_type: null,
        payment_url: 'https://www.roviniete.ro/ro/rca/details?step=vehicle',
        tip: 'Compară prețurile înainte de a cumpăra. RCA trebuie să fie pe numele noului proprietar.',
        online_action: {
          label: 'Cumpără RCA pe Roviniete.ro',
          type: 'url',
          url: 'https://www.roviniete.ro/ro/rca/details?step=vehicle',
        },
      },
    ],
  },
  car_from_germany: {
    ...
    steps: [
      {
        order: 1,
        title: 'Tradu documentele prin LibreTranslate',
        category: 'docs',
        office: 'LibreTranslate API',
        address: 'Online',
        hours: 'Variabil',
        phone: 'Variabil',
        documents: [
        ...
        fee: 'Gratuit',
        deadline: 'Primul pas — pregătește documentele pentru dosar',
        form_type: null,
        payment_url: null,
        tip: 'Alege limba documentului, încarcă PDF-ul, extragem textul, îl traducem prin LibreTranslate și generăm un PDF tradus pentru descărcare. Pentru documente scanate va fi necesar OCR.',
        online_action: {
      ...
      {
        order: 5,
        title: 'Plătești taxa DRPCIV pe ghișeu.ro',
        category: 'financial',
        ...
        fee: '49 RON certificat înmatriculare',
        deadline: 'Înainte de programarea DRPCIV — plata e obligatorie la ghișeu',
        form_type: null,
        payment_url: 'https://www.ghiseul.ro/ghiseul/public/taxe/taxe-speciale/id/eyJpZEluc3QiOiA3MjExLCAidGlwUGVycyI6MCwgInZhbGlkYXJpIjogImZhbHNlIiwgInRpdGx1IjogIlBlcm1pc2UgYXV0by8gQ2VydGlmaWNhdGUgZGUgw65ubWF0cmljdWxhcmUvIEF1dG9yaXphyJtpZSBwcm92aXpvcmllIn0%3D',
        tip: 'Pregătim plata pentru certificatul de înmatriculare pe ghișeu.ro cu datele din profil. Pe site-ul oficial mai completezi captcha și apeși Plătește.',
        online_action: {
          label: 'Plătește taxa DRPCIV',
          type: 'payment',
          amount_ron: 49,
          description: 'Certificat de înmatriculare',
          provider: 'ghiseul_drpciv',
          url: 'https://www.ghiseul.ro/ghiseul/public/taxe/taxe-speciale/id/eyJpZEluc3QiOiA3MjExLCAidGlwUGVycyI6MCwgInZhbGlkYXJpIjogImZhbHNlIiwgInRpdGx1IjogIlBlcm1pc2UgYXV0by8gQ2VydGlmaWNhdGUgZGUgw65ubWF0cmljdWxhcmUvIEF1dG9yaXphyJtpZSBwcm92aXpvcmllIn0%3D',
        },
      },
      {
        order: 6,
