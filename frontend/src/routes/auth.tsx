...
const inputClass =
  "rounded-2xl border border-border bg-surface px-4 py-3.5 text-[15px] text-text-primary placeholder:text-text-tertiary focus:outline-none focus:ring-2 focus:ring-primary/30 min-h-11 w-full";
    ...
    return (
      <div className="min-h-dvh bg-bg flex items-center justify-center p-4">
        <div className="w-full max-w-[420px] text-center">
          <span className="font-display font-bold text-[22px] text-primary block mb-8">eCetățean</span>
    ...
    <div className="min-h-dvh bg-bg flex items-center justify-center p-4">
      <div className="w-full max-w-[420px]">
        <div className="text-center mb-7">
          <span className="font-display font-bold text-[22px] text-primary">eCetățean</span>
        </div>
              ...
              <form onSubmit={tab === "signin" ? handleSignIn : handleSignUp} className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-sm font-medium text-text-primary" htmlFor="email">
                    {tab === "signup" ? "Email" : "Email sau utilizator"}
                  </label>
                  <input
                    id="email"
                    type="text"
                    ...
                    placeholder={tab === "signup" ? "nume@exemplu.ro" : "admin sau nume@exemplu.ro"}
                    className={inputClass}
                  />
                  {tab === "signin" && (
